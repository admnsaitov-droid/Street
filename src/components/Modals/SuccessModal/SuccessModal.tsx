...
export const SuccessModal = () => {
    ...
    const modalAppearSpring = useSpring({
        scale: isSubmitSuccessful ? 1 : 0.9,
        opacity: isSubmitSuccessful ? 1 : 0,
        config: {
            duration: 600,
    ...
    return (
        <StyledSuccessModal style={{pointerEvents: isSubmitSuccessful ? 'auto' : 'none', userSelect: isSubmitSuccessful ? 'auto' : 'none'}}>
